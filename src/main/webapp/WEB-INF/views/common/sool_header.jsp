      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="${path }/prof/viewInMajor.hd">학과생 조회</a>
            <a class="collapse-item" href="${path }/prof/viewInClass.hd">수강생 조회</a>
            <a class="collapse-item" href="${path }/prof/viewClassAttend.hd">수강생 출결관리</a>
            <a class="collapse-item" href="${path }/prof/editClassResult.hd">수강생 성적관리</a>
            <a class="collapse-item" href="#">강의 평가 조회</a>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item">
        ...
        <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">성적 이의 신청 조회</a>
            <a class="collapse-item" href="#">처리 결과 조회</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
       ...
       <li class="nav-item">
        ...
        <div id="collapsePages7" class="collapse" aria-labelledby="headingPages7" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">INFORMATION OF SUBJECT</h6>
            <a class="collapse-item" href="${path }/prof/upAssignment.hd">과제 등록</a>
            <a class="collapse-item" href="#">수강생 과제 조회</a>
            <a class="collapse-item" href="#">과제 등록결과 조회</a>
            <a class="collapse-item" href="#">과제 게시판 이동</a>
          </div>
        </div>
      </li>
